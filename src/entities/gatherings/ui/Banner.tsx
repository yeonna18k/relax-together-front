...
export default function Banner() {
  return (
    <div className="w-[1400px] bg-[url('/assets/gathering-bg.png')] bg-cover bg-center bg-no-repeat">
      <div className="mt-20 hidden h-[356px] w-full items-center justify-center lg:flex">
        <div className="flex w-[708px] flex-col items-center gap-[20px] p-0">
          <Image
